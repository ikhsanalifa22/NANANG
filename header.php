...
<html>
<head>
	<title>BERITA ANGKASA STORE</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +628979860572</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> beritaangkasa@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>beritaangkasa store</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #150E10"><b>BERITA ANGKASA STORE</b></a>
			</div>
